...
export const postTestHelpersIssuingTransactionsCreateForceCaptureEndpointSchema =
  {
...
export type PostTestHelpersIssuingTransactionsCreateForceCaptureRequest =
  RequestUnion<
    RequestBodyData<
      'application/x-www-form-urlencoded',
      {
...
export type PostTestHelpersIssuingTransactionsCreateForceCaptureRequestResult =
  RequestResult<
    PostTestHelpersIssuingTransactionsCreateForceCaptureRequest,
    PostTestHelpersIssuingTransactionsCreateForceCaptureResponse
  >;

export function postTestHelpersIssuingTransactionsCreateForceCapture(
...
): Promise<PostTestHelpersIssuingTransactionsCreateForceCaptureRequestResult> {
  return requestHandler.execute(
    createRequest(
      postTestHelpersIssuingTransactionsCreateForceCaptureEndpointSchema,
      payload
    ),
    config
  );
