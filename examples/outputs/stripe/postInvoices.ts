...
export const postInvoicesEndpointSchema = {
  path: '/v1/invoices',
  method: 'post',
...
export type PostInvoicesRequest = RequestUnion<
  RequestBodyData<
    'application/x-www-form-urlencoded',
    {
...
export type PostInvoicesRequestResult = RequestResult<
  PostInvoicesRequest,
...
export function postInvoices(
  ...
  payload: RequestPayload<PostInvoicesRequest, 'contentType' | 'body', never>,
  config?: RequestHandlerExecutionConfig
): Promise<PostInvoicesRequestResult> {
  return requestHandler.execute(
    createRequest(postInvoicesEndpointSchema, payload),
    config
  );
}
