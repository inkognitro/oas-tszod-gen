...
export const postSubscriptionsSubscriptionExposedIdEndpointSchema = {
...
export type PostSubscriptionsSubscriptionExposedIdRequest = RequestUnion<
  RequestBodyData<
    'application/x-www-form-urlencoded',
    {
      add_invoice_items?: {
...
export type PostSubscriptionsSubscriptionExposedIdRequestResult = RequestResult<
...
): Promise<PostSubscriptionsSubscriptionExposedIdRequestResult> {
  return requestHandler.execute(
    createRequest(
      postSubscriptionsSubscriptionExposedIdEndpointSchema,
      payload
    ),
    config
  );
