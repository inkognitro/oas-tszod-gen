...
export const postIssuingCardsEndpointSchema = {
...
export type PostIssuingCardsRequest = RequestUnion<
  RequestBodyData<
    'application/x-www-form-urlencoded',
    {
      cardholder?: string;
...
export type PostIssuingCardsRequestResult = RequestResult<
...
): Promise<PostIssuingCardsRequestResult> {
  return requestHandler.execute(
    createRequest(postIssuingCardsEndpointSchema, payload),
    config
  );
}
