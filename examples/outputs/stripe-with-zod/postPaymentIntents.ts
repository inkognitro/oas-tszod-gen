...
export const postPaymentIntentsEndpointSchema = {
...
export type PostPaymentIntentsRequest = RequestUnion<
  RequestBodyData<
    'application/x-www-form-urlencoded',
    {
      amount: number; // int
...
export type PostPaymentIntentsRequestResult = RequestResult<
...
): Promise<PostPaymentIntentsRequestResult> {
  return requestHandler.execute(
    createRequest(postPaymentIntentsEndpointSchema, payload),
    config
  );
}
