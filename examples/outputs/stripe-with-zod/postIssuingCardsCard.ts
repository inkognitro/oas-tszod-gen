...
export const postIssuingCardsCardEndpointSchema = {
...
export type PostIssuingCardsCardRequest = RequestUnion<
  RequestBodyData<
    'application/x-www-form-urlencoded',
    {
...
export type PostIssuingCardsCardRequestResult = RequestResult<
...
): Promise<PostIssuingCardsCardRequestResult> {
  return requestHandler.execute(
    createRequest(postIssuingCardsCardEndpointSchema, payload),
    config
  );
}
