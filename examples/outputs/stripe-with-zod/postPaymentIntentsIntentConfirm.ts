...
export const postPaymentIntentsIntentConfirmEndpointSchema = {
...
export type PostPaymentIntentsIntentConfirmRequest = RequestUnion<
  RequestBodyData<
    'application/x-www-form-urlencoded',
    {
...
export type PostPaymentIntentsIntentConfirmRequestResult = RequestResult<
...
): Promise<PostPaymentIntentsIntentConfirmRequestResult> {
  return requestHandler.execute(
    createRequest(postPaymentIntentsIntentConfirmEndpointSchema, payload),
    config
  );
}
