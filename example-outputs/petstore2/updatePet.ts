...
export type UpdatePetResponse = Response<200, ResponseData<ResponseBodyData<'application/xml', Pet> | ResponseBodyData<'application/json', Pet>>> | Response<400, any> | Response<404, any> | Response<405, any>

export type UpdatePetRequestResult = RequestResult<Request, UpdatePetResponse>

export function updatePet(requestHandler: RequestHandler, payload: UpdatePetPayload, config?: RequestHandlerExecutionConfig): Promise<UpdatePetRequestResult> {return requestHandler.execute(createRequest({...payload,
endpointSchema: updatePetEndpointSchema}), config);}