...
export type JsonContentValue = null
|string
|number
|boolean
...
...settings,
id: requestId,
url: createRequestUrl(settings.endpointSchema.path, settings.pathParams ?? {}),
...
export type ResponseData<B extends ResponseBodyData = any,
H extends ResponseHeaders = any,
C extends ResponseSetCookies = any> = B & {
headers: H;
cookies: C;
}

export type Response<S extends number = any,
D extends ResponseData = any> = D & {
status: S;
}
