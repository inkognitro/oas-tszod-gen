...
export const postTestHelpersIssuingAuthorizationsEndpointSchema = {
  ...
  bodyByContentType: {
    'application/x-www-form-urlencoded': {
      zodSchema: z.object({
        ...
        amount_details: z
          .object({
            atm_fee: z.number().int().safe().finite().optional(),
            cashback_amount: z.number().int().safe().finite().optional(),
          })
          .optional(),
...
export type PostTestHelpersIssuingAuthorizationsRequest = RequestUnion<
  RequestBodyData<
    'application/x-www-form-urlencoded',
    {
      amount: number; // int
...
export type PostTestHelpersIssuingAuthorizationsRequestResult = RequestResult<
  PostTestHelpersIssuingAuthorizationsRequest,
  PostTestHelpersIssuingAuthorizationsResponse
>;

export function postTestHelpersIssuingAuthorizations(
...
): Promise<PostTestHelpersIssuingAuthorizationsRequestResult> {
  return requestHandler.execute(
    createRequest(postTestHelpersIssuingAuthorizationsEndpointSchema, payload),
    config
  );
}
