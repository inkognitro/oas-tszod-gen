...
export const postSetupIntentsEndpointSchema = {
...
export type PostSetupIntentsRequest = RequestUnion<
  RequestBodyData<
    'application/x-www-form-urlencoded',
    {
...
export type PostSetupIntentsRequestResult = RequestResult<
...
): Promise<PostSetupIntentsRequestResult> {
  return requestHandler.execute(
    createRequest(postSetupIntentsEndpointSchema, payload),
    config
  );
}
