...
export const z_Treasury_Credit_reversal = z.object({
...
export const z_Treasury_Debit_reversal = z.object({
  amount: z.number().int().safe().finite(),
  created: z.number().int().safe().finite(),
  currency: z.string(),
...
export const z_Treasury_Outbound_payment = z.object({
  amount: z.number().int().safe().finite(),
...
export const z_Treasury_Outbound_transfer = z.object({
  amount: z.number().int().safe().finite(),
  cancelable: z.boolean(),
  created: z.number().int().safe().finite(),
  currency: z.string(),
  ...
  statement_descriptor: z.string(),
  status: z.enum(['canceled', 'failed', 'posted', 'processing', 'returned']),
  status_transitions: z_Treasury_outbound_transfers_resource_status_transitions,
  tracking_details:
...
export const z_Treasury_Received_credit = z.object({
  amount: z.number().int().safe().finite(),
  created: z.number().int().safe().finite(),
  currency: z.string(),
...
export const z_Treasury_Received_debit = z.object({
  amount: z.number().int().safe().finite(),
  created: z.number().int().safe().finite(),
  currency: z.string(),
  description: z.string(),
...
export const z_Treasury_Transaction_entry = z.object({
