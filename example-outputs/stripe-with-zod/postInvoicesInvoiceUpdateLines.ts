...
export const postInvoicesInvoiceUpdateLinesEndpointSchema = {
...
export type PostInvoicesInvoiceUpdateLinesRequest = RequestUnion<
  RequestBodyData<
    'application/x-www-form-urlencoded',
    {
      expand?: string[];
...
export type PostInvoicesInvoiceUpdateLinesRequestResult = RequestResult<
  PostInvoicesInvoiceUpdateLinesRequest,
  PostInvoicesInvoiceUpdateLinesResponse
>;

export function postInvoicesInvoiceUpdateLines(
...
): Promise<PostInvoicesInvoiceUpdateLinesRequestResult> {
  return requestHandler.execute(
    createRequest(postInvoicesInvoiceUpdateLinesEndpointSchema, payload),
    config
  );
}
