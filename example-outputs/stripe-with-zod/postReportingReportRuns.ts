...
export const postReportingReportRunsEndpointSchema = {
...
export type PostReportingReportRunsRequest = RequestUnion<
  RequestBodyData<
    'application/x-www-form-urlencoded',
    {
      expand?: string[];
...
export type PostReportingReportRunsRequestResult = RequestResult<
  PostReportingReportRunsRequest,
...
): Promise<PostReportingReportRunsRequestResult> {
  return requestHandler.execute(
    createRequest(postReportingReportRunsEndpointSchema, payload),
    config
  );
}
