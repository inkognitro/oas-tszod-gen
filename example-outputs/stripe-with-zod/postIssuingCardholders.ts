...
export const postIssuingCardholdersEndpointSchema = {
...
export type PostIssuingCardholdersRequest = RequestUnion<
  RequestBodyData<
    'application/x-www-form-urlencoded',
    {
      billing: {
...
export type PostIssuingCardholdersRequestResult = RequestResult<
  PostIssuingCardholdersRequest,
  PostIssuingCardholdersResponse
>;
...
): Promise<PostIssuingCardholdersRequestResult> {
  return requestHandler.execute(
    createRequest(postIssuingCardholdersEndpointSchema, payload),
    config
  );
}
