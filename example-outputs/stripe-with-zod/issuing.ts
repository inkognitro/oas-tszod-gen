...
export const z_Issuing_Card = z.object({
  brand: z.string(),
...
export const z_Issuing_Dispute = z.object({
...
// @ts-ignore - due to schema recursion
export const z_Issuing_Transaction = z.object({
  amount: z.number().int().safe().finite(),
...
// @ts-ignore - due to schema recursion
export const z_Issuing_Authorization = z.object({
  amount: z.number().int().safe().finite(),
