...
export const postSetupIntentsIntentConfirmEndpointSchema = {
          ...
          .union([
            z.object({
              customer_acceptance: z.object({
                accepted_at: z.number().int().safe().finite().optional(),
...
export type PostSetupIntentsIntentConfirmRequest = RequestUnion<
  RequestBodyData<
    'application/x-www-form-urlencoded',
    {
...
export type PostSetupIntentsIntentConfirmRequestResult = RequestResult<
  PostSetupIntentsIntentConfirmRequest,
...
): Promise<PostSetupIntentsIntentConfirmRequestResult> {
  return requestHandler.execute(
    createRequest(postSetupIntentsIntentConfirmEndpointSchema, payload),
    config
  );
}
