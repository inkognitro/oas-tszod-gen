...
import {OrderResponseAck, OrderResponseResult, OrderResponseFull, Error} from '@example-outputs/binance';
...
export type PostOrderResponse = ResponseUnion<200, ResponseBodyData<'application/json', OrderResponseAck
|OrderResponseResult
|OrderResponseFull>> | ResponseUnion<400, ResponseBodyData<'application/json', Error>> | ResponseUnion<401, ResponseBodyData<'application/json', Error>>
