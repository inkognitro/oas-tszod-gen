...
import {SubAccountUSDTFuturesPositionRisk, SubAccountCOINFuturesPositionRisk, Error} from '@example-outputs/binance';
...
export type GetPositionRiskResponse = ResponseUnion<200, ResponseBodyData<'application/json', SubAccountUSDTFuturesPositionRisk
|SubAccountCOINFuturesPositionRisk>> | ResponseUnion<400, ResponseBodyData<'application/json', Error>> | ResponseUnion<401, ResponseBodyData<'application/json', Error>>
