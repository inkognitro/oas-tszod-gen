...
export type DeleteOrderResponse = ResponseUnion<200, ResponseBodyData<'application/json', MarginOrder>> | ResponseUnion<400, ResponseBodyData<'application/json', Error>> | ResponseUnion<401, ResponseBodyData<'application/json', Error>>
