...
export type GetOrderResponse = ResponseUnion<200, ResponseBodyData<'application/json', MarginOrderDetail>> | ResponseUnion<400, ResponseBodyData<'application/json', Error>> | ResponseUnion<401, ResponseBodyData<'application/json', Error>>
