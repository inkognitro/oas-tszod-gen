...
export type GetIdRequest = RequestUnion<any,
any,
{
'planId'?: number; // int
'requestId'?: string;
...
export type GetIdResponse = ResponseUnion<200, ResponseBodyData<'application/json', {
...
export function getId(requestHandler: SimpleRequestHandler, payload: RequestPayload<GetIdRequest, 'queryParams', never>, config?: RequestHandlerExecutionConfig): Promise<GetIdRequestResult> {return requestHandler.execute(createRequest(getIdEndpointSchema,
payload), config);}