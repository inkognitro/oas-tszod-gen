...
export function getRedemptionRecord(requestHandler: SimpleRequestHandler, payload: RequestPayload<GetRedemptionRecordRequest, 'queryParams', never>, config?: RequestHandlerExecutionConfig): Promise<GetRedemptionRecordRequestResult> {return requestHandler.execute(createRequest(getRedemptionRecordEndpointSchema,
payload), config);}