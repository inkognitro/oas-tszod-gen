  ...
  queryParamsZodSchema: z.object({
    ...
    type: z
      .union([
        ...
        z.literal('BORROW'),
        z.literal('REPAY'),
        z.literal('BUY_INCOME'),
        z.literal('BUY_EXPENSE'),
        z.literal('SELL_INCOME'),
        z.literal('SELL_EXPENSE'),
        z.literal('TRADING_COMMISSION'),
        z.literal('BUY_LIQUIDATION'),
        z.literal('SELL_LIQUIDATION'),
        z.literal('REPAY_LIQUIDATION'),
        z.literal('OTHER_LIQUIDATION'),
        z.literal('LIQUIDATION_FEE'),
        z.literal('SMALL_BALANCE_CONVERT'),
        z.literal('COMMISSION_RETURN'),
        z.literal('SMALL_CONVERT'),
      ])
      .optional(),
