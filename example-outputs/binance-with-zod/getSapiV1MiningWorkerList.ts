...
export type GetSapiV1MiningWorkerListResponse = Response<200, ResponseData<ResponseBodyData<'application/json', {
'code': number; // int
'msg': string;
'data': {
'workerDatas': ({
...
export type GetSapiV1MiningWorkerListRequestResult = RequestResult<Request, GetSapiV1MiningWorkerListResponse>

export function getSapiV1MiningWorkerList(requestHandler: RequestHandler, payload: GetSapiV1MiningWorkerListPayload, config?: RequestHandlerExecutionConfig): Promise<GetSapiV1MiningWorkerListRequestResult> {return requestHandler.execute(createRequest({...payload,
endpointSchema: getSapiV1MiningWorkerListEndpointSchema}), config);}