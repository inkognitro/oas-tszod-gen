...
export type GetSapiV1SubAccountTransactionStatisticsResponse = Response<200, ResponseData<ResponseBodyData<'application/json', {
...
export type GetSapiV1SubAccountTransactionStatisticsRequestResult = RequestResult<Request, GetSapiV1SubAccountTransactionStatisticsResponse>

export function getSapiV1SubAccountTransactionStatistics(requestHandler: RequestHandler, payload: GetSapiV1SubAccountTransactionStatisticsPayload, config?: RequestHandlerExecutionConfig): Promise<GetSapiV1SubAccountTransactionStatisticsRequestResult> {return requestHandler.execute(createRequest({...payload,
endpointSchema: getSapiV1SubAccountTransactionStatisticsEndpointSchema}), config);}