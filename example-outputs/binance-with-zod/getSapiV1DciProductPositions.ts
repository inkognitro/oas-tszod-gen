...
'status': z.union([z.literal('PENDING'),z.literal('PURCHASE_SUCCESS'),z.literal('SETTLED'),z.literal('PURCHASE_FAIL'),z.literal('REFUNDING'),z.literal('REFUND_SUCCESS'),z.literal('SETTLING')]).optional(),
