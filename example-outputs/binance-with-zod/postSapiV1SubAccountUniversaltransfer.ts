...
'fromAccountType': z.union([z.literal('SPOT'),z.literal('USDT_FUTURE'),z.literal('COIN_FUTURE'),z.literal('MARGIN'),z.literal('ISOLATED_MARGIN')]),
'toAccountType': z.union([z.literal('SPOT'),z.literal('USDT_FUTURE'),z.literal('COIN_FUTURE'),z.literal('MARGIN'),z.literal('ISOLATED_MARGIN')]),
