...
'status': z.union([z.literal('ALL'),z.literal('SUBSCRIBABLE'),z.literal('UNSUBSCRIBABLE')]).optional(),
'isSortAsc': z.boolean().optional(),
'sortBy': z.union([z.literal('START_TIME'),z.literal('LOT_SIZE'),z.literal('INTEREST_RATE'),z.literal('DURATION')]).optional(),
...
export type GetSapiV1LendingProjectListResponse = Response<200, ResponseData<ResponseBodyData<'application/json', ({
'asset': string;
...
export type GetSapiV1LendingProjectListRequestResult = RequestResult<Request, GetSapiV1LendingProjectListResponse>

export function getSapiV1LendingProjectList(requestHandler: RequestHandler, payload: GetSapiV1LendingProjectListPayload, config?: RequestHandlerExecutionConfig): Promise<GetSapiV1LendingProjectListRequestResult> {return requestHandler.execute(createRequest({...payload,
endpointSchema: getSapiV1LendingProjectListEndpointSchema}), config);}