...
export type GetApiV3MypreventedmatchesResponse = Response<200, ResponseData<ResponseBodyData<'application/json', ({
'symbol': string;
'preventedMatchId': number; // int
...
export type GetApiV3MypreventedmatchesRequestResult = RequestResult<Request, GetApiV3MypreventedmatchesResponse>

export function getApiV3Mypreventedmatches(requestHandler: RequestHandler, payload: GetApiV3MypreventedmatchesPayload, config?: RequestHandlerExecutionConfig): Promise<GetApiV3MypreventedmatchesRequestResult> {return requestHandler.execute(createRequest({...payload,
endpointSchema: getApiV3MypreventedmatchesEndpointSchema}), config);}