import {subAccountUSDTFuturesPositionRiskZodSchema, subAccountCOINFuturesPositionRiskZodSchema, errorZodSchema, SubAccountUSDTFuturesPositionRisk, SubAccountCOINFuturesPositionRisk, Error} from '@/test-outputs/binance-with-zod';
import {z} from 'zod';
...
bodyByContentType: {
'application/json': {
zodSchema: z.union([subAccountUSDTFuturesPositionRiskZodSchema,subAccountCOINFuturesPositionRiskZodSchema])
}
}
},
'400': {
