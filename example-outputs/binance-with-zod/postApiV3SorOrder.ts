...
export type PostApiV3SorOrderResponse = Response<200, ResponseData<ResponseBodyData<'application/json', {
'symbol': string;
'orderId': number; // int
...
export type PostApiV3SorOrderRequestResult = RequestResult<Request, PostApiV3SorOrderResponse>

export function postApiV3SorOrder(requestHandler: RequestHandler, payload: PostApiV3SorOrderPayload, config?: RequestHandlerExecutionConfig): Promise<PostApiV3SorOrderRequestResult> {return requestHandler.execute(createRequest({...payload,
endpointSchema: postApiV3SorOrderEndpointSchema}), config);}