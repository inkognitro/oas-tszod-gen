...
'stopLimitTimeInForce': z.union([z.literal('GTC'),z.literal('FOK'),z.literal('IOC')]).optional(),
...
export type PostApiV3OrderOcoResponse = Response<200, ResponseData<ResponseBodyData<'application/json', {
...
export type PostApiV3OrderOcoRequestResult = RequestResult<Request, PostApiV3OrderOcoResponse>

export function postApiV3OrderOco(requestHandler: RequestHandler, payload: PostApiV3OrderOcoPayload, config?: RequestHandlerExecutionConfig): Promise<PostApiV3OrderOcoRequestResult> {return requestHandler.execute(createRequest({...payload,
endpointSchema: postApiV3OrderOcoEndpointSchema}), config);}