...
'managerSubUserInfoVoList': z.array(z.object({
...
export type GetSapiV1ManagedSubaccountInfoResponse = Response<200, ResponseData<ResponseBodyData<'application/json', {
'total': number; // int
...
export type GetSapiV1ManagedSubaccountInfoRequestResult = RequestResult<Request, GetSapiV1ManagedSubaccountInfoResponse>

export function getSapiV1ManagedSubaccountInfo(requestHandler: RequestHandler, payload: GetSapiV1ManagedSubaccountInfoPayload, config?: RequestHandlerExecutionConfig): Promise<GetSapiV1ManagedSubaccountInfoRequestResult> {return requestHandler.execute(createRequest({...payload,
endpointSchema: getSapiV1ManagedSubaccountInfoEndpointSchema}), config);}