import {orderResponseAckZodSchema, orderResponseResultZodSchema, orderResponseFullZodSchema, errorZodSchema, OrderResponseAck, OrderResponseResult, OrderResponseFull, Error} from '@/test-outputs/binance-with-zod';
import {z} from 'zod';
...
bodyByContentType: {
'application/json': {
zodSchema: z.union([orderResponseAckZodSchema,orderResponseResultZodSchema,orderResponseFullZodSchema])
}
}
},
'400': {
