...
export type GetApiV3ExchangeinfoResponse = Response<200, ResponseData<ResponseBodyData<'application/json', {
'timezone': string;
...
export type GetApiV3ExchangeinfoRequestResult = RequestResult<Request, GetApiV3ExchangeinfoResponse>

export function getApiV3Exchangeinfo(requestHandler: RequestHandler, payload: GetApiV3ExchangeinfoPayload, config?: RequestHandlerExecutionConfig): Promise<GetApiV3ExchangeinfoRequestResult> {return requestHandler.execute(createRequest({...payload,
endpointSchema: getApiV3ExchangeinfoEndpointSchema}), config);}