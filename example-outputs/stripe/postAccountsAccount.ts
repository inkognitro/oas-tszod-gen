...
export const postAccountsAccountEndpointSchema = {
...
export type PostAccountsAccountRequest = RequestUnion<
  RequestBodyData<
    'application/x-www-form-urlencoded',
    {
...
export type PostAccountsAccountRequestResult = RequestResult<
...
): Promise<PostAccountsAccountRequestResult> {
  return requestHandler.execute(
    createRequest(postAccountsAccountEndpointSchema, payload),
    config
  );
}
