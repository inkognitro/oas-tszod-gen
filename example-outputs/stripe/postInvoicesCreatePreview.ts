...
export const postInvoicesCreatePreviewEndpointSchema = {
...
export type PostInvoicesCreatePreviewRequest = RequestUnion<
  RequestBodyData<
    'application/x-www-form-urlencoded',
    {
      automatic_tax?: {
...
export type PostInvoicesCreatePreviewRequestResult = RequestResult<
  PostInvoicesCreatePreviewRequest,
  PostInvoicesCreatePreviewResponse
>;

export function postInvoicesCreatePreview(
...
): Promise<PostInvoicesCreatePreviewRequestResult> {
  return requestHandler.execute(
    createRequest(postInvoicesCreatePreviewEndpointSchema, payload),
    config
  );
}
