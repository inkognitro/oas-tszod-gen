...
> :warning: - **Requirement**  
> If you want to use the generated code output on the backend side, then `node >= 18.0.0` is required
> to support the [Blob](https://nodejs.org/docs/v20.17.0/api/globals.html#class-blob) class.
