...
the generated output is built from scratch again. Not commiting the generated output into the repository will make sure,
that custom changes are committed which will be lost anyway after another execution of `generateOas3ToTs`.
