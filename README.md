...
A `output` is an object which has a `path` property in it. This property is of type `OutputPath` (or simply: `string[]`).
...
The remaining entries of this array are used for type or variable name.
