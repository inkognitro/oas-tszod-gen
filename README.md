...
## Generator: What is an OutputPath?
...
## Code usage: Create and use the RequestHandler
...
## Code usage: RequestHandler implementations
...
## Code usage: RequestHandler - Promises: `resolve` vs `reject`
